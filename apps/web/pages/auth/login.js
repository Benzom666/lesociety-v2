        ...
        <div className="container">
          <div className="auth-section">
            ...
            {width > 767 && (
              <div className="dont-have">
                <p>
                  Don't have an account? <Link legacyBehavior href="/">Register</Link>
                </p>
          ...
          {width > 767 && (
            <p className="terms-cond-text">
              ...
              <Link legacyBehavior href="/TermOfUse">terms</Link> and{" "}
              <Link legacyBehavior href="/PrivacyPolicies">privacy policy</Link>.
            </p>
          )}
        </div>
      </div>
